...
.. raw:: html
    ...
    and prone to errors. This automation offers the potential for faster, more accurate and
    cost-effective diagnosis.
    <p>

    <p>
    In this post, we will use the Long Short-Term Memory Fully Convolutional Network (LSTM-FCN)
    for categorizing
    <p>
...
[2] Kachuee, M., Fazeli, S., & Sarrafzadeh, M. (2018). ECG heartbeat classification: A deep transferable representation.
