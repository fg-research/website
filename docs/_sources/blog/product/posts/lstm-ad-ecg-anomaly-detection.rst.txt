...
.. raw:: html
    ...
    <p>
    Detecting anomalies in electrocardiogram (ECG) signals is crucial for early diagnosis and treatment of cardiovascular diseases.
    The introduction of wearable ECG sensors enables continuous remote monitoring of patients' cardiac activity.
    However, it is unfeasible for physicians to manually review the large amount of data generated by real time ECG sensors.
    ...
    Long Short-Term Memory Network for Anomaly Detection (LSTM-AD)</a> <a href="#references">[2]</a>,
