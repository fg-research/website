...
.. raw:: html
    ...
    <p>
    Several recent papers have investigated the benefits of machine learning approaches
...
.. raw:: html
    ...
    which is the one relevant to this post, the predictions are generated by averaging
    the target values in each subset of the feature space.
    </p>

    <p>
    It follows that a decision tree
    can be seen as a nonparametric regression model where the regression function that
    links the target to the features is estimated using a piecewise constant approximation.
    </p>
