...
The model fits a Gaussian distribution to the prediction errors obtained on normal data.
...
The algorithm supports both univariate and multivariate time series.
...
The model fits a Gaussian distribution to the reconstruction errors obtained on normal data.
