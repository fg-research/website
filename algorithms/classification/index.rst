...
The algorithm trains an ensemble of InceptionTime networks and derives the final predicted class labels by averaging the class probabilities predicted by the different networks.
