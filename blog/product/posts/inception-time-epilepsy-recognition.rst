...
.. raw:: html
    ...
    risk of accidents or unexpected death. Furthermore, continuous remote monitoring of epileptic
    patients allows healthcare providers to collect more accurate and detailed data on seizure
    ...
    patients as an alternative to more invasive electroencephalographic (EEG) systems, and it
    has been shown that deep learning models can be effective at detecting epileptic seizures
