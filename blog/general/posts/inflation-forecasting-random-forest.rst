...
.. raw:: html
    ...
    into different subsets, and generating a constant prediction for each subset which,
    in the regression case, is obtained by averaging
    the target values in the subset.
