...
.. raw:: html
    ...
    We will run an AutoML job for optimizing the hyperparameters of an XGBoost classifier
    to predict the direction of the S&P500 (up or down) one day ahead using as input
    a set of technical indicators.
    </p>

    <p>
    We will download the daily price and volume time series of the S&P500 from the
