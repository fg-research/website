...
def google_analytics(app, pagename, templatename, context, doctree):
    ...
    _iub.csConfiguration = {
        ...
        "i18n":{"en":{"banner":{
            "dynamic":{"body":"fg-research.com and selected third parties use cookies or similar technologies for technical purposes and, with your consent, for functionality, experience, measurement and marketing (personalized ads). Use the “Accept” button to consent. Use the “Reject” button to continue without accepting."}}}},
            "banner":{
